...
**Candidate source commit:** `799324551bf723270d9e7e5982173071728f01a1`  
...
| Secret/upload/dependency exclusion | PASS locally | Package builder excludes `config.local.php`, `.env*`, `uploads/`, and `node_modules/`; final archives still require inventory and secret-pattern verification. |
...
5. Complete desktop/mobile browser smoke tests on the exact candidate and rerun final CI on the exact release commit.
